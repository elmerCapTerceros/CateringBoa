...
export class ErpNavigationService {
    ...
    private _navigationStore: Map<string, ErpNavigationItem[]> = new Map<
        string,
        any
    >();
     ...
     * @param navigation
     */
    storeNavigation(key: string, navigation: ErpNavigationItem[]): void {
        // Add to the store
     ...
     * @param key
     */
    getNavigation(key: string): ErpNavigationItem[] {
    ...
    getFlatNavigation(
        ...
        flatNavigation: ErpNavigationItem[] = []
    ): ErpNavigationItem[] {
    ...
    getItemParent(
        id: string,
        navigation: ErpNavigationItem[],
        parent: ErpNavigationItem[] | ErpNavigationItem
    ): ErpNavigationItem[] | ErpNavigationItem | null {
        for (const item of navigation) {
            if (item.id === id) {
                return parent;
            }
