            ...
            const schemeCustomProps = _.map(
                ...
                (colorScheme) => {
                    ...
                    const background = theme(
                        `erp.customProps.background.${colorScheme}`
                    );
                    const foreground = theme(
                        `erp.customProps.foreground.${colorScheme}`
                    );
                        ...
                        _.flatten(
                            _.map(
                                ...
                                (name) => [
                                    [
                                        name,
                                        `rgba(var(--erp-${name}-rgb), <alpha-value>)`,
                                    ],
                                    [
                                        `on-${name}`,
                                        `rgba(var(--erp-on-${name}-rgb), <alpha-value>)`,
                                    ],
                                ]
                            )
                        )
