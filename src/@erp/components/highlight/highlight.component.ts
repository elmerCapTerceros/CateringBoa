...
import { ErpHighlightService } from '@erp/components/highlight/highlight.service';

@Component({
    selector: 'textarea[erp-highlight]',
    templateUrl: './highlight.component.html',
    styleUrls: ['./highlight.component.scss'],
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs: 'erpHighlight',
    standalone: true,
    imports: [NgClass],
})
export class ErpHighlightComponent implements OnChanges, AfterViewInit {
    private _domSanitizer = inject(DomSanitizer);
    private _elementRef = inject(ElementRef);
    private _erpHighlightService = inject(ErpHighlightService);
    ...
    private _highlightAndInsert(): void {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(
            ...
            this._erpHighlightService.highlight(this.code, this.lang)
        );
