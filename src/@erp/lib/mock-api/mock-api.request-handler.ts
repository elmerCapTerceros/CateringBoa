...
import { ErpMockApiReplyCallback } from '@erp/lib/mock-api/mock-api.types';
import { Observable, of, take, throwError } from 'rxjs';

export class ErpMockApiHandler {
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: ErpMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: ErpMockApiReplyCallback): void {
        // Store the reply
